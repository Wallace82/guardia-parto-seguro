    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
      ...
      <div class="flex flex-wrap gap-2">
        <button 
          ...
          Todos
          <span class="text-lg font-bold" [class.text-primary-400]="activeTab === 'all'">12</span>
        </button>
        ...
        <button 
          ...
          Críticos
          <span class="text-lg font-bold" [class.text-danger-500]="activeTab === 'critical'">2</span>
        </button>
        ...
        <button 
          ...
          Atenção
          <span class="text-lg font-bold" [class.text-warning]="activeTab === 'moderate'">4</span>
        </button>
        ...
        <button 
          ...
          Informativos
          <span class="text-lg font-bold" [class.text-primary-400]="activeTab === 'informative'">6</span>
        </button>
      </div>
